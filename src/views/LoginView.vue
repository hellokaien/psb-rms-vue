          ...
          <div class="mt-2">
            ...
            <p class="mt-3 flex items-center justify-center gap-1.5 text-center text-xs tracking-wide text-gray-400">
              <svg class="h-3.5 w-3.5 text-[#34A853]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M10 1.944A11.954 11.954 0 0 1 3 4.56V9c0 4.55 2.85 8.43 7 9.96 4.15-1.53 7-5.41 7-9.96V4.56a11.954 11.954 0 0 1-7-2.616Zm3.03 5.526a.75.75 0 0 1 0 1.06l-3.5 3.5a.75.75 0 0 1-1.06 0l-1.5-1.5a.75.75 0 0 1 1.06-1.06L9 10.44l2.97-2.97a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd" />
              </svg>
            ...
            <p
              v-if="signInMessage"
              class="mt-3 rounded-xl bg-blue-50 px-3 py-2 text-center text-xs leading-5 text-blue-700"
              role="status"
            >
              {{ signInMessage }}
            </p>
